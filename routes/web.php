...
Route::group(['namespace'=>'\App\Http\Controllers'], function (){
    ...
    Route::get('/inscription', 'ArianeController@account')->name('inscription');
    Route::post('/traite', 'ArianeController@traitement')->name('traitement');


    Route::get('/reservation', 'ArianeController@reserver')->name('reservation');
    Route::get('/login', 'ArianeController@connexion')->name('connexion');
    Route::get('/mets', 'ArianeController@mets')->name('mets');
    Route::get('/entrees', 'ArianeController@entree')->name('nos_entrees');
    Route::get('/desserts', 'ArianeController@dessert')->name('nos_desserts');
    Route::get('/boissons', 'ArianeController@boisson')->name('nos_boissons');
